...
tags:
  - React
  - JavaScript
excerpt: How the use() hook pairs with Suspense to read promises in render, trim waterfalls, and keep loading states declarative.
---
...
## Minimal example: promise-in-render
...
> Rejected promises surface as render errors—wrap with an error boundary or handle errors inside the promise chain before passing to `use()`.
