...
tags:
  - Python
excerpt: Replace deep if/elif chains with match/case, capture sub-patterns, and guard with when for readable command and event dispatch.
---
